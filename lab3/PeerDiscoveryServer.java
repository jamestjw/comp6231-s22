...
public class PeerDiscoveryServer implements Runnable {
    ...
    public void run() {
        ...
        System.out.println(String.format("%s ready for peer discovery at port %d", repoId, repoServerPort));
        try {
            while (true) {
                ...
                System.out.println(String.format("%s received peer discovery msg: %s", repoId, msg));

                if (args[0].equals("DISCOVER_FUIFSERVER_REQUEST")) {
