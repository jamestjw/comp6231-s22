...
public interface Repository extends Remote {
    ...
    public void upload(String filename, int filesize, IRemoteInputStream data) throws RemoteException, IOException, BrokenFileException, InsufficientStorageException, DuplicateFilenameException, NoSuchAlgorithmException;
