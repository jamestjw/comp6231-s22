...
public class RMIServer {
    ...
    public synchronized static <T extends Remote> void register(T obj, String name) throws RemoteException {
    ...
    public static class MPIProxy {
        ...
        public void Recv(final Object buf, final int offset, final int len, final Datatype datatype, final int dest, final int tag) throws MPIException {
            invoke(() -> MPI.COMM_WORLD.Recv(buf, offset, len, datatype, dest, tag));
        }
    }
}
